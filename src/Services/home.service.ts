    ...
    return {
      ...
      user: [
        ...
        },
        {
          ...
          method: 'GET',
          description: 'Get all users information except login info',
        },
        {
          title: 'Update user',
          url: this.configService.get<string>('API_ENDPOINT') + '/user',
          method: 'PATCH',
          description: 'Update a given user need body JSON',
        },
      ],
      task: [
        {
          ...
          method: 'POST',
          description: 'Create a given task need body JSON',
        },
        {
          ...
          method: 'GET',
          description: 'Get all task for one specific user id tasks',
        },
        {
          title: 'Get all db tasks',
          url: this.configService.get<string>('API_ENDPOINT') + '/task/all',
          method: 'GET',
          description: 'Get a all tasks of all users',
        },
        {
          title: 'Get last task id',
          url: this.configService.get<string>('API_ENDPOINT') + '/task/last',
          method: 'GET',
          description: 'Get last created task id',
        },
        {
          title: 'Update task',
          url: this.configService.get<string>('API_ENDPOINT') + '/task',
          method: 'PATCH',
          description: 'Update a given task need body JSON',
        },
        {
          title: 'Delete a task',
          url: this.configService.get<string>('API_ENDPOINT') + '/task/{:id}',
          method: 'DELETE',
          description: 'Delete a given task by id',
        },
      ],
      github: [
        {
          ...
          method: 'POST',
          description: 'Create a new github, need a JSON body',
        },
        {
          ...
          url:
            ...
            '/github/user/{:id}',
          method: 'GET',
          description: 'Find a github by user id',
        },
        {
          title: 'Update a github',
          url: this.configService.get<string>('API_ENDPOINT') + '/github',
          method: 'PATCH',
          description: 'Update a given github, need a JSON body',
        },
      ],
      file: [
        {
          title: 'upload an jpg and png file',
          url: this.configService.get<string>('API_ENDPOINT') + '/file/upload',
          method: 'POST',
          description: 'Upload a file mime type image/jpg and image/png',
        },
      ],
    };
  }
